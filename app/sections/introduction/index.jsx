...
export function WelcomeSection() {
	...
	const [text] = useState([
		"build desktop apps with Windows Forms VB.NET",
		"build web apps with Codeigniter, Laravel, and React",
		"build mobile apps with React Native and Kotlin",
			...
			<section id="intro" className="section" ref={introRef}>
				<div className="grid grid-cols-1 md:grid-cols-[1fr_0.5fr] lg:grid-cols-[1fr_0.7fr] gap-4 items-center">
					<div className="py-5 md:py-10">
						...
						>
							<p>
								Hi, I&apos;m <mark>Novandi</mark> a <mark>enthusiastic</mark> software developer.
							</p>
						</h1>
						...
						>
							Don&apos;t go anywhere, I&apos;ll be showcasing my latest work for you to explore.
						</p>
						<div
							ref={ref}
							style={{
